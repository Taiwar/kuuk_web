...
export interface IQuery {
  ...
  filterRecipes(
    filterRecipesInput?: Nullable<FilterRecipesInput>
  ): Nullable<RecipeDTO>[] | Promise<Nullable<RecipeDTO>[]>;
...
export interface IMutation {
  createRecipe(
    createRecipeInput?: Nullable<CreateRecipeInput>
  ): Nullable<RecipeDTO> | Promise<Nullable<RecipeDTO>>;
  importRecipe(url: string): Nullable<RecipeDTO> | Promise<Nullable<RecipeDTO>>;
  updateRecipe(
    updateRecipeInput?: Nullable<UpdateRecipeInput>
  ): Nullable<RecipeDTO> | Promise<Nullable<RecipeDTO>>;
  deleteRecipe(
    id: string
  ): Nullable<DeletionResponse> | Promise<Nullable<DeletionResponse>>;
  addIngredient(
    addIngredientInput?: Nullable<AddIngredientInput>
  ): Nullable<IngredientDTO> | Promise<Nullable<IngredientDTO>>;
  updateIngredient(
    updateIngredientInput?: Nullable<UpdateIngredientInput>
  ):
    | Nullable<GroupItemUpdateResponse>
    | Promise<Nullable<GroupItemUpdateResponse>>;
  removeIngredient(
    ingredientID: string
  ):
    | Nullable<GroupItemDeletionResponse>
    | Promise<Nullable<GroupItemDeletionResponse>>;
  addStep(
    addStepInput?: Nullable<AddStepInput>
  ): Nullable<StepDTO> | Promise<Nullable<StepDTO>>;
  updateStep(
    updateStepInput?: Nullable<UpdateStepInput>
  ):
    | Nullable<GroupItemUpdateResponse>
    | Promise<Nullable<GroupItemUpdateResponse>>;
  removeStep(
    ...
    | Promise<Nullable<GroupItemDeletionResponse>>;
  addNote(
    addNoteInput?: Nullable<AddNoteInput>
  ): Nullable<NoteDTO> | Promise<Nullable<NoteDTO>>;
  updateNote(
    updateNoteInput?: Nullable<UpdateNoteInput>
  ):
    | Nullable<GroupItemUpdateResponse>
    | Promise<Nullable<GroupItemUpdateResponse>>;
  removeNote(
    ...
    | Promise<Nullable<GroupItemDeletionResponse>>;
  addGroup(
    addGroupInput?: Nullable<AddGroupInput>
  ): Nullable<GroupDTO> | Promise<Nullable<GroupDTO>>;
  updateGroup(
    updateGroupInput?: Nullable<UpdateGroupInput>
  ): Nullable<GroupDTO> | Promise<Nullable<GroupDTO>>;
  removeGroup(
    groupID: string
  ): Nullable<DeletionResponse> | Promise<Nullable<DeletionResponse>>;
