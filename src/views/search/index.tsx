...
export function Search(): JSX.Element {
  ...
  if (filterRecipeResults.loading || tagResults.loading)
    ...
    <div>
      ...
      <div className="container px-4">
        <div className="flex bg-white shadow rounded-lg p-4">
          <form onSubmit={handleSubmit(onSubmitFilter)}>
            <div className="grid grid-cols-5 gap-4">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Select
                    ...
                    inputRef={field.ref}
                    options={tagResults.data.tags.map((t: string) => ({
                      value: t,
                      label: t,
                    }))}
              ...
              />
              <button
                className="col-span-1 rounded-full shadow bg-pink-400 text-white w-11"
                type="submit"
              >
        ...
        <div className="grid grid-cols-4 gap-4 mt-4">
          {!!filterRecipeResults.data &&
            filterRecipeResults.data.filterRecipes.map((recipe: RecipeDTO) => (
