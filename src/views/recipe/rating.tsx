...
export function RecipeRating(props: RecipeRatingProps): JSX.Element {
  ...
  const watchRating = parseInt(
    watch('rating', recipe.rating ?? defaultRating).toString(),
  );
    ...
    <div className="star-rating">
      <fieldset>
        <input
          ...
          {...register('rating')}
        />
        <label className={`text-${size}`} htmlFor="star1" title="Outstanding">
          1 stars
        </label>
        <input
          id="star2"
          ...
          {...register('rating')}
        />
        <label className={`text-${size}`} htmlFor="star2" title="Outstanding">
          2 stars
        </label>
        <input
          id="star3"
          ...
          {...register('rating')}
        />
        <label className={`text-${size}`} htmlFor="star3" title="Outstanding">
          3 stars
        </label>
        <input
          id="star4"
          ...
          {...register('rating')}
        />
        <label className={`text-${size}`} htmlFor="star4" title="Outstanding">
          4 stars
        </label>
        <input
          id="star5"
          ...
          {...register('rating')}
        />
        <label className={`text-${size}`} htmlFor="star5" title="Outstanding">
          5 stars
        </label>
      </fieldset>
    </div>
